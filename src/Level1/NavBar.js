    ...
    return (
        <>
            ...
            <div className='navbar-container'>
                <input className="navbar-search" type="text" placeholder="Search by post, author, or topic" onChange={(e)=>props.searchHandler(e.target.value)} />
            ...
            <div>
                <button className="filter-button" onClick={()=>setFilter(true)}>Add Filters</button>
                {filter &&
