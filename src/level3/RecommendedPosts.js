...
const RecommendedPosts = () => {
  ...
  useEffect(() => {
    ...
    // Set the Recommended posts based on the sorted array
    setRecommendedPosts(postsWithAvgLikes.slice(0,2));
    //

    //Also add some posts on the basis of interest of user..
